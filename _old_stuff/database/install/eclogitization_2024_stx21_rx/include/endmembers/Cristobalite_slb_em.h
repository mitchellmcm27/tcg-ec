#ifndef CRISTOBALITE_SLB_EM_H
#define CRISTOBALITE_SLB_EM_H
...
extern "C" {
#include "Cristobalite_slb_em_coder.h"
}


class Cristobalite_slb_em: public EndMember
{
public:
  // Constructor
  Cristobalite_slb_em();
