...
result = 8.3144626181532395*T*(n1*log(n1*x0) + n2*log(n2*x0)) + n1*(*endmember[0].mu0)(T, P) + n2*(*endmember[1].mu0)(T, P);
    return result;
}
...
static void coder_dgdn(double T, double P, double n[2], double result[2]) {
    ...
    double x3 = n1*x1;
    double x4 = pow(x0, -2);
    double x5 = 8.3144626181532395*T;
...
static void coder_d3gdn3(double T, double P, double n[2], double result[2]) {
    ...
    double x18 = 8.3144626181532395*T;
    double x19 = 1.0/n2;
...
result = 8.3144626181532395*n1*log(n1*x0) + n1*(*endmember[0].dmu0dT)(T, P) + 8.3144626181532395*n2*log(n2*x0) + n2*(*endmember[1].dmu0dT)(T, P);
    return result;
}
...
result[0] = -8.3144626181532395*x2 + x5*(-n1*x4 + x1) + 8.3144626181532395*log(x3) + (*endmember[0].dmu0dT)(T, P);
result[1] = -8.3144626181532395*x3 + x5*(-n2*x4 + x1) + 8.3144626181532395*log(x2) + (*endmember[1].dmu0dT)(T, P);
}
...
static void coder_d4gdn3dt(double T, double P, double n[2], double result[2]) {
    ...
    double x3 = 8.3144626181532395*n1 + 8.3144626181532395*n2;
    double x4 = pow(x0, -3);
    double x5 = 6*x4;
    ...
    double x16 = 33.257850472612958*x4;
    double x17 = 16.628925236306479*x4;
    double x18 = n1*x16 - n2*x17;
    double x19 = x11*x14 + x18;
    double x20 = -n2*x1 + x13;
    double x21 = 8.3144626181532395/n2;

result[0] = x12*(x10 + x8) + x19 + x2 + x3*(x5 + x7) - x14*x15/((n1)*(n1));
result[1] = -16.628925236306479*x1 + x12*(-x1 + x10) + x19 + x3*(4*x4 + x7);
result[2] = 8.3144626181532395*x1 + x18 + x3*(x7 + x9);
