#ifndef ECLOGITIZATION_AGU26_STX21_RX_H
#define ECLOGITIZATION_AGU26_STX21_RX_H

#include "Reaction.h"
#include "phases.h"

class eclogitization_agu26_stx21_rx: public Reaction
{
public:
  // Constructor
  eclogitization_agu26_stx21_rx();

  // Destructor
  virtual ~eclogitization_agu26_stx21_rx();
