#ifndef ECLOGITIZATION_AGU23_STX21_RX_H
#define ECLOGITIZATION_AGU23_STX21_RX_H

#include "Reaction.h"
#include "phases.h"

class eclogitization_agu23_stx21_rx: public Reaction
{
public:
  // Constructor
  eclogitization_agu23_stx21_rx();

  // Destructor
  virtual ~eclogitization_agu23_stx21_rx();
