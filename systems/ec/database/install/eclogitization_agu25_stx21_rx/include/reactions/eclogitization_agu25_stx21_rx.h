#ifndef ECLOGITIZATION_AGU25_STX21_RX_H
#define ECLOGITIZATION_AGU25_STX21_RX_H

#include "Reaction.h"
#include "phases.h"

class eclogitization_agu25_stx21_rx: public Reaction
{
public:
  // Constructor
  eclogitization_agu25_stx21_rx();

  // Destructor
  virtual ~eclogitization_agu25_stx21_rx();
