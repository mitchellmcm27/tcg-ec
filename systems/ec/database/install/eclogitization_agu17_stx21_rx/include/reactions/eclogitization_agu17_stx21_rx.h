#ifndef ECLOGITIZATION_AGU17_STX21_RX_H
#define ECLOGITIZATION_AGU17_STX21_RX_H

#include "Reaction.h"
#include "phases.h"

class eclogitization_agu17_stx21_rx: public Reaction
{
public:
  // Constructor
  eclogitization_agu17_stx21_rx();

  // Destructor
  virtual ~eclogitization_agu17_stx21_rx();
