#ifndef ECLOGITIZATION_MATLAB_STX21_RX_H
#define ECLOGITIZATION_MATLAB_STX21_RX_H

#include "Reaction.h"
#include "phases.h"

class eclogitization_matlab_stx21_rx: public Reaction
{
public:
  // Constructor
  eclogitization_matlab_stx21_rx();

  // Destructor
  virtual ~eclogitization_matlab_stx21_rx();
