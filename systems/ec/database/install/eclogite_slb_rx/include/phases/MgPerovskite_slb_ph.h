#ifndef MGPEROVSKITE_SLB_PH_H
#define MGPEROVSKITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "MgPerovskite_slb_ph_coder.h"
}

class MgPerovskite_slb_ph: public Phase
{
public:
  // Constructor
  MgPerovskite_slb_ph();
