#ifndef FEPOSTPEROVSKITE_SLB_PH_H
#define FEPOSTPEROVSKITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "FePostPerovskite_slb_ph_coder.h"
}

class FePostPerovskite_slb_ph: public Phase
{
public:
  // Constructor
  FePostPerovskite_slb_ph();

  // Destructor
  virtual ~FePostPerovskite_slb_ph();
