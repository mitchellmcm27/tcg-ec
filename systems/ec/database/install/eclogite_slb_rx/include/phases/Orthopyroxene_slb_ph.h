#ifndef ORTHOPYROXENE_SLB_PH_H
#define ORTHOPYROXENE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "Orthopyroxene_slb_ph_coder.h"
}

class Orthopyroxene_slb_ph: public Phase
{
public:
  // Constructor
  Orthopyroxene_slb_ph();

  // Destructor
  virtual ~Orthopyroxene_slb_ph();
