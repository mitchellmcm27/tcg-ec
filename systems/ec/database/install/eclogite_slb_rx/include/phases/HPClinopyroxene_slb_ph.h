#ifndef HPCLINOPYROXENE_SLB_PH_H
#define HPCLINOPYROXENE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "HPClinopyroxene_slb_ph_coder.h"
}

class HPClinopyroxene_slb_ph: public Phase
{
public:
  // Constructor
  HPClinopyroxene_slb_ph();

  // Destructor
  virtual ~HPClinopyroxene_slb_ph();
