#ifndef MGTSCHERMAKS_SLB_PH_H
#define MGTSCHERMAKS_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "MgTschermaks_slb_ph_coder.h"
}

class MgTschermaks_slb_ph: public Phase
{
public:
  // Constructor
  MgTschermaks_slb_ph();
