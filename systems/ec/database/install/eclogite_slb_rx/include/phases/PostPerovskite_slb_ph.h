#ifndef POSTPEROVSKITE_SLB_PH_H
#define POSTPEROVSKITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "PostPerovskite_slb_ph_coder.h"
}

class PostPerovskite_slb_ph: public Phase
{
public:
  // Constructor
  PostPerovskite_slb_ph();

  // Destructor
  virtual ~PostPerovskite_slb_ph();
