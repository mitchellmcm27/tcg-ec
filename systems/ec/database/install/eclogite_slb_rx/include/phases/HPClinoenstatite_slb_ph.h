#ifndef HPCLINOENSTATITE_SLB_PH_H
#define HPCLINOENSTATITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "HPClinoenstatite_slb_ph_coder.h"
}

class HPClinoenstatite_slb_ph: public Phase
{
public:
  // Constructor
  HPClinoenstatite_slb_ph();

  // Destructor
  virtual ~HPClinoenstatite_slb_ph();
