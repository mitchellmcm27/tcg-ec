#ifndef MAGNESIOWUESTITE_SLB_PH_H
#define MAGNESIOWUESTITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "Magnesiowuestite_slb_ph_coder.h"
}

class Magnesiowuestite_slb_ph: public Phase
{
public:
  // Constructor
  Magnesiowuestite_slb_ph();

  // Destructor
  virtual ~Magnesiowuestite_slb_ph();
