#ifndef RINGWOODITE_SLB_PH_H
#define RINGWOODITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "Ringwoodite_slb_ph_coder.h"
}

class Ringwoodite_slb_ph: public Phase
{
public:
  // Constructor
  Ringwoodite_slb_ph();
