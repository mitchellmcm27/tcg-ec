#ifndef FECAFERRITE_SLB_PH_H
#define FECAFERRITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "FeCaFerrite_slb_ph_coder.h"
}

class FeCaFerrite_slb_ph: public Phase
{
public:
  // Constructor
  FeCaFerrite_slb_ph();
