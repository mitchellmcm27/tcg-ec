#ifndef ORTHODIOPSIDE_SLB_PH_H
#define ORTHODIOPSIDE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "OrthoDiopside_slb_ph_coder.h"
}

class OrthoDiopside_slb_ph: public Phase
{
public:
  // Constructor
  OrthoDiopside_slb_ph();

  // Destructor
  virtual ~OrthoDiopside_slb_ph();
