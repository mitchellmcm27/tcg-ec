#ifndef MGWADSLEYITE_SLB_PH_H
#define MGWADSLEYITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "MgWadsleyite_slb_ph_coder.h"
}

class MgWadsleyite_slb_ph: public Phase
{
public:
  // Constructor
  MgWadsleyite_slb_ph();
