#ifndef ALAKIMOTOITE_SLB_PH_H
#define ALAKIMOTOITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "AlAkimotoite_slb_ph_coder.h"
}

class AlAkimotoite_slb_ph: public Phase
{
public:
  // Constructor
  AlAkimotoite_slb_ph();
