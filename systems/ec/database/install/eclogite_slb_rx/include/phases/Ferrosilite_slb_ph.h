#ifndef FERROSILITE_SLB_PH_H
#define FERROSILITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "Ferrosilite_slb_ph_coder.h"
}

class Ferrosilite_slb_ph: public Phase
{
public:
  // Constructor
  Ferrosilite_slb_ph();
