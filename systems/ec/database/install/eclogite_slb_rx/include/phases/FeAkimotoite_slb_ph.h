#ifndef FEAKIMOTOITE_SLB_PH_H
#define FEAKIMOTOITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "FeAkimotoite_slb_ph_coder.h"
}

class FeAkimotoite_slb_ph: public Phase
{
public:
  // Constructor
  FeAkimotoite_slb_ph();
