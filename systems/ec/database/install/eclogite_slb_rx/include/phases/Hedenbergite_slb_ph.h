#ifndef HEDENBERGITE_SLB_PH_H
#define HEDENBERGITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "Hedenbergite_slb_ph_coder.h"
}

class Hedenbergite_slb_ph: public Phase
{
public:
  // Constructor
  Hedenbergite_slb_ph();
