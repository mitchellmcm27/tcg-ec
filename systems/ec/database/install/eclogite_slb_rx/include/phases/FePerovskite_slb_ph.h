#ifndef FEPEROVSKITE_SLB_PH_H
#define FEPEROVSKITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "FePerovskite_slb_ph_coder.h"
}

class FePerovskite_slb_ph: public Phase
{
public:
  // Constructor
  FePerovskite_slb_ph();
