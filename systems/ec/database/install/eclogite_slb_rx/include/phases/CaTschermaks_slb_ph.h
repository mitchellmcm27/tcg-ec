#ifndef CATSCHERMAKS_SLB_PH_H
#define CATSCHERMAKS_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "CaTschermaks_slb_ph_coder.h"
}

class CaTschermaks_slb_ph: public Phase
{
public:
  // Constructor
  CaTschermaks_slb_ph();
