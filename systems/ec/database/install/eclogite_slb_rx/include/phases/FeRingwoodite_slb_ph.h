#ifndef FERINGWOODITE_SLB_PH_H
#define FERINGWOODITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "FeRingwoodite_slb_ph_coder.h"
}

class FeRingwoodite_slb_ph: public Phase
{
public:
  // Constructor
  FeRingwoodite_slb_ph();

  // Destructor
  virtual ~FeRingwoodite_slb_ph();
