#ifndef ALPOSTPEROVSKITE_SLB_PH_H
#define ALPOSTPEROVSKITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "AlPostPerovskite_slb_ph_coder.h"
}

class AlPostPerovskite_slb_ph: public Phase
{
public:
  // Constructor
  AlPostPerovskite_slb_ph();

  // Destructor
  virtual ~AlPostPerovskite_slb_ph();
