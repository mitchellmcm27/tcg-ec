#ifndef NACAFERRITE_SLB_PH_H
#define NACAFERRITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "NaCaFerrite_slb_ph_coder.h"
}

class NaCaFerrite_slb_ph: public Phase
{
public:
  // Constructor
  NaCaFerrite_slb_ph();
