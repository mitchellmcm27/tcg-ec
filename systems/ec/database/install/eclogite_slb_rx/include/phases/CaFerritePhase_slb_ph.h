#ifndef CAFERRITEPHASE_SLB_PH_H
#define CAFERRITEPHASE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "CaFerritePhase_slb_ph_coder.h"
}

class CaFerritePhase_slb_ph: public Phase
{
public:
  // Constructor
  CaFerritePhase_slb_ph();

  // Destructor
  virtual ~CaFerritePhase_slb_ph();
