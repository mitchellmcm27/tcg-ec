#ifndef MGAKIMOTOITE_SLB_PH_H
#define MGAKIMOTOITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "MgAkimotoite_slb_ph_coder.h"
}

class MgAkimotoite_slb_ph: public Phase
{
public:
  // Constructor
  MgAkimotoite_slb_ph();
