...
result = 1.0*x1*(5000.0*n1*n2 + 1.0*x0*(8.3144626181532395*T*(2.0*n1*x2 + 4.0*n1*log(n1*x1) - 4.3287821201550702*n1 + 7.0*n2*x2 + 4.0*n2*log(n2*x1) - 4.3287821201550702*n2) + n1*(*endmember[0].mu0)(T, P) + n2*(*endmember[1].mu0)(T, P)));
    return result;
}
...
result[1] = x16 + x27*(5000.0*n1 + x19*(x14*(x13 + x20*(-n2*x1 + x5) + x24*x28 + x25*x28 - 4.0*x6 + x9 - 4.3287821201550702) + x4) + x26);
}
...
static void coder_d2gdn2(double T, double P, double n[2], double result[2]) {
    ...
    double x59 = x14*x58;
    double x60 = x17*(5000.0*n1 + x20*(x4 + x59) + x35);
...
result[1] = x16 - 1.0*x36 + x53*(1.0*x3 + x34 + 1.0*x4 + x52*(x0*x31 - x21 + x29*x61 + x37*(-x17 + x40) + x44*x61 - 1.75*x47 - 6.125*x48 + x51 + 2.0*x57) + x59 + 5000.0) - 1.0*x60;
...
static void coder_d3gdn3(double T, double P, double n[2], double result[2]) {
    ...
    double x107 = 5000.0*n1 + x22*(x106 + x4) + x37;
    double x108 = x107*x19;
    double x109 = 4.0*x19;
    double x110 = x18 - 2.0*x24*(x106 + 1.0*x3 + x36 + 1.0*x4 + x84*x95 + 5000.0);
    double x111 = 1.0/n2;
