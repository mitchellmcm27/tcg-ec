#ifndef MGPOSTPEROVSKITE_SLB_EM_H
#define MGPOSTPEROVSKITE_SLB_EM_H
...
class MgPostPerovskite_slb_em: public EndMember
{
public:
  // Constructor
  MgPostPerovskite_slb_em();

  // Destructor
  virtual ~MgPostPerovskite_slb_em();
