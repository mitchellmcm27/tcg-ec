#ifndef ALPOSTPEROVSKITE_SLB_EM_H
#define ALPOSTPEROVSKITE_SLB_EM_H
...
class AlPostPerovskite_slb_em: public EndMember
{
public:
  // Constructor
  AlPostPerovskite_slb_em();

  // Destructor
  virtual ~AlPostPerovskite_slb_em();
