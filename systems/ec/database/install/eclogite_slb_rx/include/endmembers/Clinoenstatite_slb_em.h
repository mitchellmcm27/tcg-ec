#ifndef CLINOENSTATITE_SLB_EM_H
#define CLINOENSTATITE_SLB_EM_H
...
class Clinoenstatite_slb_em: public EndMember
{
public:
  // Constructor
  Clinoenstatite_slb_em();

  // Destructor
  virtual ~Clinoenstatite_slb_em();
