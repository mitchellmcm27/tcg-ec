#ifndef HPCLINOFERROSILITE_SLB_EM_H
#define HPCLINOFERROSILITE_SLB_EM_H
...
class HPClinoferrosilite_slb_em: public EndMember
{
public:
  // Constructor
  HPClinoferrosilite_slb_em();

  // Destructor
  virtual ~HPClinoferrosilite_slb_em();
  ...
  // Check whether coder errors occurred during execution
  int check_coder_error();

  // Reset the coder error flag to 0 after an error occurs
  void reset_coder_error();
