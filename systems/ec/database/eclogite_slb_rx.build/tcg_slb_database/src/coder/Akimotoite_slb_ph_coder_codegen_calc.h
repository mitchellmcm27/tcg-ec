...
result = 1.0*x2*(66000.0*n1*n3 + 1.0*x1*(8.3144626181532395*T*(1.0*n1*log(n1*x2) + 1.0*n2*log(n2*x2) + 2.0*n3*log(n3*x2) + 1.0*x0*log(x0*x2)) + n1*(*endmember[0].mu0)(T, P) + n2*(*endmember[1].mu0)(T, P) + n3*(*endmember[2].mu0)(T, P)));
    return result;
}
...
result[2] = x18 + x26*(66000.0*n1 + x22*(x15*(2.0*x1*(-n3*x2 + x7) + x13 - x21*x7 + x23 + x27) + x6) + x25);
}
...
static void coder_d2gdn2(double T, double P, double n[3], double result[3]) {
    ...
    double x70 = 66000.0*n1 + x23*(x3 + x68) + x35;
    double x71 = -x53*x70;
...
result[2] = x43*(x52*(x55 + x65) + x61 + x69 + 66000.0) + x64 + x71;
...
static void coder_d3gdn3(double T, double P, double n[3], double result[3]) {
    ...
    double x120 = 66000.0*n1 + x22*(x119 + x3) + x35;
    double x121 = x120*x42;
    double x122 = x109*x14;
    double x123 = x119 + 1.0*x3;
    double x124 = x102 + x122*x22 + x123 + 66000.0;
