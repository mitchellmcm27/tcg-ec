#ifndef HPCLINOENSTATITE_SLB_EM_H
#define HPCLINOENSTATITE_SLB_EM_H
...
class HPClinoenstatite_slb_em: public EndMember
{
public:
  // Constructor
  HPClinoenstatite_slb_em();

  // Destructor
  virtual ~HPClinoenstatite_slb_em();
