#ifndef FEPOSTPEROVSKITE_SLB_EM_H
#define FEPOSTPEROVSKITE_SLB_EM_H
...
class FePostPerovskite_slb_em: public EndMember
{
public:
  // Constructor
  FePostPerovskite_slb_em();

  // Destructor
  virtual ~FePostPerovskite_slb_em();
