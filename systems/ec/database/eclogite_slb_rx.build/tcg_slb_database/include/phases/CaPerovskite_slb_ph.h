#ifndef CAPEROVSKITE_SLB_PH_H
#define CAPEROVSKITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "CaPerovskite_slb_ph_coder.h"
}

class CaPerovskite_slb_ph: public Phase
{
public:
  // Constructor
  CaPerovskite_slb_ph();
