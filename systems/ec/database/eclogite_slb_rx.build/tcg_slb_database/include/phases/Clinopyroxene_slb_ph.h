#ifndef CLINOPYROXENE_SLB_PH_H
#define CLINOPYROXENE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "Clinopyroxene_slb_ph_coder.h"
}

class Clinopyroxene_slb_ph: public Phase
{
public:
  // Constructor
  Clinopyroxene_slb_ph();

  // Destructor
  virtual ~Clinopyroxene_slb_ph();
