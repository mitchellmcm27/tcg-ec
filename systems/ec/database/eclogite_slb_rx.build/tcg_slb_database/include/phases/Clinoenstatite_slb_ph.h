#ifndef CLINOENSTATITE_SLB_PH_H
#define CLINOENSTATITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "Clinoenstatite_slb_ph_coder.h"
}

class Clinoenstatite_slb_ph: public Phase
{
public:
  // Constructor
  Clinoenstatite_slb_ph();

  // Destructor
  virtual ~Clinoenstatite_slb_ph();
