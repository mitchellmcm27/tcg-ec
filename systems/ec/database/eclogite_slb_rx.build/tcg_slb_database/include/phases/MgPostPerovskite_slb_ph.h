#ifndef MGPOSTPEROVSKITE_SLB_PH_H
#define MGPOSTPEROVSKITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "MgPostPerovskite_slb_ph_coder.h"
}

class MgPostPerovskite_slb_ph: public Phase
{
public:
  // Constructor
  MgPostPerovskite_slb_ph();

  // Destructor
  virtual ~MgPostPerovskite_slb_ph();
