#ifndef MGFEPEROVSKITE_SLB_PH_H
#define MGFEPEROVSKITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "MgFePerovskite_slb_ph_coder.h"
}

class MgFePerovskite_slb_ph: public Phase
{
public:
  // Constructor
  MgFePerovskite_slb_ph();

  // Destructor
  virtual ~MgFePerovskite_slb_ph();
