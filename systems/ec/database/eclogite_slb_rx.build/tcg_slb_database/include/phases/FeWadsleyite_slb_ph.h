#ifndef FEWADSLEYITE_SLB_PH_H
#define FEWADSLEYITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "FeWadsleyite_slb_ph_coder.h"
}

class FeWadsleyite_slb_ph: public Phase
{
public:
  // Constructor
  FeWadsleyite_slb_ph();
