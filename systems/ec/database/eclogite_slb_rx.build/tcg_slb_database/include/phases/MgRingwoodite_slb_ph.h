#ifndef MGRINGWOODITE_SLB_PH_H
#define MGRINGWOODITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "MgRingwoodite_slb_ph_coder.h"
}

class MgRingwoodite_slb_ph: public Phase
{
public:
  // Constructor
  MgRingwoodite_slb_ph();

  // Destructor
  virtual ~MgRingwoodite_slb_ph();
