#ifndef ALPEROVSKITE_SLB_PH_H
#define ALPEROVSKITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "AlPerovskite_slb_ph_coder.h"
}

class AlPerovskite_slb_ph: public Phase
{
public:
  // Constructor
  AlPerovskite_slb_ph();
