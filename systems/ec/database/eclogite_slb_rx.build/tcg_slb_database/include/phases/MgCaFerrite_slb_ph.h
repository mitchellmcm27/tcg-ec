#ifndef MGCAFERRITE_SLB_PH_H
#define MGCAFERRITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "MgCaFerrite_slb_ph_coder.h"
}

class MgCaFerrite_slb_ph: public Phase
{
public:
  // Constructor
  MgCaFerrite_slb_ph();
