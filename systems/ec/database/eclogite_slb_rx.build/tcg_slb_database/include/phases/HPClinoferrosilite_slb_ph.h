#ifndef HPCLINOFERROSILITE_SLB_PH_H
#define HPCLINOFERROSILITE_SLB_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "HPClinoferrosilite_slb_ph_coder.h"
}

class HPClinoferrosilite_slb_ph: public Phase
{
public:
  // Constructor
  HPClinoferrosilite_slb_ph();

  // Destructor
  virtual ~HPClinoferrosilite_slb_ph();
