#ifndef CLINOPYROXENE_STX21_PH_H
#define CLINOPYROXENE_STX21_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "Clinopyroxene_stx21_ph_coder.h"
}

class Clinopyroxene_stx21_ph: public Phase
{
public:
  // Constructor
  Clinopyroxene_stx21_ph();

  // Destructor
  virtual ~Clinopyroxene_stx21_ph();
