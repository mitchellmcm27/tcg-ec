#ifndef ORTHOPYROXENE_STX21_PH_H
#define ORTHOPYROXENE_STX21_PH_H

#include "Phase.h"
#include "endmembers.h"

extern "C" {
#include "Orthopyroxene_stx21_ph_coder.h"
}

class Orthopyroxene_stx21_ph: public Phase
{
public:
  // Constructor
  Orthopyroxene_stx21_ph();

  // Destructor
  virtual ~Orthopyroxene_stx21_ph();
