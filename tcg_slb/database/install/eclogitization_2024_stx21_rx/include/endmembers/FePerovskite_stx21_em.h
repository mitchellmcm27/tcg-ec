#ifndef FEPEROVSKITE_STX21_EM_H
#define FEPEROVSKITE_STX21_EM_H
...
extern "C" {
#include "FePerovskite_stx21_em_coder.h"
}


class FePerovskite_stx21_em: public EndMember
{
public:
  // Constructor
  FePerovskite_stx21_em();

  // Destructor
  virtual ~FePerovskite_stx21_em();
