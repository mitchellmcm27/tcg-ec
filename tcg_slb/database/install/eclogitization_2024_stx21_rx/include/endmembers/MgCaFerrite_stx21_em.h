#ifndef MGCAFERRITE_STX21_EM_H
#define MGCAFERRITE_STX21_EM_H
...
extern "C" {
#include "MgCaFerrite_stx21_em_coder.h"
}


class MgCaFerrite_stx21_em: public EndMember
{
public:
  // Constructor
  MgCaFerrite_stx21_em();

  // Destructor
  virtual ~MgCaFerrite_stx21_em();
