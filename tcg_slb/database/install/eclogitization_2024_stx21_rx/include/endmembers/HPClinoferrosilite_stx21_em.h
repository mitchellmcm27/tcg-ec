#ifndef HPCLINOFERROSILITE_STX21_EM_H
#define HPCLINOFERROSILITE_STX21_EM_H
...
extern "C" {
#include "HPClinoferrosilite_stx21_em_coder.h"
}


class HPClinoferrosilite_stx21_em: public EndMember
{
public:
  // Constructor
  HPClinoferrosilite_stx21_em();

  // Destructor
  virtual ~HPClinoferrosilite_stx21_em();
