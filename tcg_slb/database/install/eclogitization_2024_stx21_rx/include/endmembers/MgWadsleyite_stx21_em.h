#ifndef MGWADSLEYITE_STX21_EM_H
#define MGWADSLEYITE_STX21_EM_H
...
extern "C" {
#include "MgWadsleyite_stx21_em_coder.h"
}


class MgWadsleyite_stx21_em: public EndMember
{
public:
  // Constructor
  MgWadsleyite_stx21_em();

  // Destructor
  virtual ~MgWadsleyite_stx21_em();
