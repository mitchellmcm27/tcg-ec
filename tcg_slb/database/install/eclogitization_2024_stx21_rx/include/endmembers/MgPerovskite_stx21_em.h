#ifndef MGPEROVSKITE_STX21_EM_H
#define MGPEROVSKITE_STX21_EM_H
...
extern "C" {
#include "MgPerovskite_stx21_em_coder.h"
}


class MgPerovskite_stx21_em: public EndMember
{
public:
  // Constructor
  MgPerovskite_stx21_em();

  // Destructor
  virtual ~MgPerovskite_stx21_em();
