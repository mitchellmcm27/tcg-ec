#ifndef NEPHELINE_STX21_EM_H
#define NEPHELINE_STX21_EM_H
...
extern "C" {
#include "Nepheline_stx21_em_coder.h"
}


class Nepheline_stx21_em: public EndMember
{
public:
  // Constructor
  Nepheline_stx21_em();
