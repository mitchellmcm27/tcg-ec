#ifndef ORTHODIOPSIDE_STX21_EM_H
#define ORTHODIOPSIDE_STX21_EM_H
...
class OrthoDiopside_stx21_em: public EndMember
{
public:
  // Constructor
  OrthoDiopside_stx21_em();

  // Destructor
  virtual ~OrthoDiopside_stx21_em();
