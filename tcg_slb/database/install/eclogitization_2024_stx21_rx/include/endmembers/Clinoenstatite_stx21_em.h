#ifndef CLINOENSTATITE_STX21_EM_H
#define CLINOENSTATITE_STX21_EM_H
...
class Clinoenstatite_stx21_em: public EndMember
{
public:
  // Constructor
  Clinoenstatite_stx21_em();

  // Destructor
  virtual ~Clinoenstatite_stx21_em();
