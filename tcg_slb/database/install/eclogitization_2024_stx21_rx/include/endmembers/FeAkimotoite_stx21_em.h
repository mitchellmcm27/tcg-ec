#ifndef FEAKIMOTOITE_STX21_EM_H
#define FEAKIMOTOITE_STX21_EM_H
...
extern "C" {
#include "FeAkimotoite_stx21_em_coder.h"
}


class FeAkimotoite_stx21_em: public EndMember
{
public:
  // Constructor
  FeAkimotoite_stx21_em();

  // Destructor
  virtual ~FeAkimotoite_stx21_em();
