#ifndef PERICLASE_STX21_EM_H
#define PERICLASE_STX21_EM_H
...
extern "C" {
#include "Periclase_stx21_em_coder.h"
}


class Periclase_stx21_em: public EndMember
{
public:
  // Constructor
  Periclase_stx21_em();
