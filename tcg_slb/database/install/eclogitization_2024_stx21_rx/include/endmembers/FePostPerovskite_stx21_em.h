#ifndef FEPOSTPEROVSKITE_STX21_EM_H
#define FEPOSTPEROVSKITE_STX21_EM_H
...
extern "C" {
#include "FePostPerovskite_stx21_em_coder.h"
}


class FePostPerovskite_stx21_em: public EndMember
{
public:
  // Constructor
  FePostPerovskite_stx21_em();

  // Destructor
  virtual ~FePostPerovskite_stx21_em();
