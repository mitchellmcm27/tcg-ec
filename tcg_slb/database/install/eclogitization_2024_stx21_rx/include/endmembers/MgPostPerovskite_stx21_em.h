#ifndef MGPOSTPEROVSKITE_STX21_EM_H
#define MGPOSTPEROVSKITE_STX21_EM_H
...
extern "C" {
#include "MgPostPerovskite_stx21_em_coder.h"
}


class MgPostPerovskite_stx21_em: public EndMember
{
public:
  // Constructor
  MgPostPerovskite_stx21_em();

  // Destructor
  virtual ~MgPostPerovskite_stx21_em();
