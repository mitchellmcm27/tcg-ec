#ifndef HPCLINOENSTATITE_STX21_EM_H
#define HPCLINOENSTATITE_STX21_EM_H
...
extern "C" {
#include "HPClinoenstatite_stx21_em_coder.h"
}


class HPClinoenstatite_stx21_em: public EndMember
{
public:
  // Constructor
  HPClinoenstatite_stx21_em();

  // Destructor
  virtual ~HPClinoenstatite_stx21_em();
