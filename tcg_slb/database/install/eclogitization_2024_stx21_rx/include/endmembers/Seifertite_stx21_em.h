#ifndef SEIFERTITE_STX21_EM_H
#define SEIFERTITE_STX21_EM_H
...
extern "C" {
#include "Seifertite_stx21_em_coder.h"
}


class Seifertite_stx21_em: public EndMember
{
public:
  // Constructor
  Seifertite_stx21_em();
