#ifndef STISHOVITE_STX21_EM_H
#define STISHOVITE_STX21_EM_H
...
extern "C" {
#include "Stishovite_stx21_em_coder.h"
}


class Stishovite_stx21_em: public EndMember
{
public:
  // Constructor
  Stishovite_stx21_em();
