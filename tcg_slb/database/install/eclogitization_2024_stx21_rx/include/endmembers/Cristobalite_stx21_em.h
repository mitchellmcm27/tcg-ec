#ifndef CRISTOBALITE_STX21_EM_H
#define CRISTOBALITE_STX21_EM_H
...
extern "C" {
#include "Cristobalite_stx21_em_coder.h"
}


class Cristobalite_stx21_em: public EndMember
{
public:
  // Constructor
  Cristobalite_stx21_em();

  // Destructor
  virtual ~Cristobalite_stx21_em();
