#ifndef MGTSCHERMAKS_STX21_EM_H
#define MGTSCHERMAKS_STX21_EM_H
...
class MgTschermaks_stx21_em: public EndMember
{
public:
  // Constructor
  MgTschermaks_stx21_em();

  // Destructor
  virtual ~MgTschermaks_stx21_em();
