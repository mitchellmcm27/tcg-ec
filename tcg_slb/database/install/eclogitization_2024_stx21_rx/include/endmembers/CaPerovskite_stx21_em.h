#ifndef CAPEROVSKITE_STX21_EM_H
#define CAPEROVSKITE_STX21_EM_H
...
extern "C" {
#include "CaPerovskite_stx21_em_coder.h"
}


class CaPerovskite_stx21_em: public EndMember
{
public:
  // Constructor
  CaPerovskite_stx21_em();

  // Destructor
  virtual ~CaPerovskite_stx21_em();
