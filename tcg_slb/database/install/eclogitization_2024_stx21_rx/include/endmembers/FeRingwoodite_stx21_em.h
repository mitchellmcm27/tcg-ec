#ifndef FERINGWOODITE_STX21_EM_H
#define FERINGWOODITE_STX21_EM_H
...
extern "C" {
#include "FeRingwoodite_stx21_em_coder.h"
}


class FeRingwoodite_stx21_em: public EndMember
{
public:
  // Constructor
  FeRingwoodite_stx21_em();

  // Destructor
  virtual ~FeRingwoodite_stx21_em();
