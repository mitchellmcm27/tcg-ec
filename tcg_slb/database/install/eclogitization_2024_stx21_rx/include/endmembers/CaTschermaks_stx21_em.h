#ifndef CATSCHERMAKS_STX21_EM_H
#define CATSCHERMAKS_STX21_EM_H
...
class CaTschermaks_stx21_em: public EndMember
{
public:
  // Constructor
  CaTschermaks_stx21_em();

  // Destructor
  virtual ~CaTschermaks_stx21_em();
