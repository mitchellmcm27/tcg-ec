#ifndef MGAKIMOTOITE_STX21_EM_H
#define MGAKIMOTOITE_STX21_EM_H
...
extern "C" {
#include "MgAkimotoite_stx21_em_coder.h"
}


class MgAkimotoite_stx21_em: public EndMember
{
public:
  // Constructor
  MgAkimotoite_stx21_em();

  // Destructor
  virtual ~MgAkimotoite_stx21_em();
