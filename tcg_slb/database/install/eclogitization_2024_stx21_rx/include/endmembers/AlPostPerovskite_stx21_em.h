#ifndef ALPOSTPEROVSKITE_STX21_EM_H
#define ALPOSTPEROVSKITE_STX21_EM_H
...
extern "C" {
#include "AlPostPerovskite_stx21_em_coder.h"
}


class AlPostPerovskite_stx21_em: public EndMember
{
public:
  // Constructor
  AlPostPerovskite_stx21_em();

  // Destructor
  virtual ~AlPostPerovskite_stx21_em();
