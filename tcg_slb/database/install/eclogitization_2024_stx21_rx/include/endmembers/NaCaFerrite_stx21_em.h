#ifndef NACAFERRITE_STX21_EM_H
#define NACAFERRITE_STX21_EM_H
...
extern "C" {
#include "NaCaFerrite_stx21_em_coder.h"
}


class NaCaFerrite_stx21_em: public EndMember
{
public:
  // Constructor
  NaCaFerrite_stx21_em();

  // Destructor
  virtual ~NaCaFerrite_stx21_em();
