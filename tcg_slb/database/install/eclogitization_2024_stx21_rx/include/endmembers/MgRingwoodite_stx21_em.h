#ifndef MGRINGWOODITE_STX21_EM_H
#define MGRINGWOODITE_STX21_EM_H
...
extern "C" {
#include "MgRingwoodite_stx21_em_coder.h"
}


class MgRingwoodite_stx21_em: public EndMember
{
public:
  // Constructor
  MgRingwoodite_stx21_em();

  // Destructor
  virtual ~MgRingwoodite_stx21_em();
