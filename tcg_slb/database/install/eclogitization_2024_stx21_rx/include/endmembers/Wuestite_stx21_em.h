#ifndef WUESTITE_STX21_EM_H
#define WUESTITE_STX21_EM_H
...
extern "C" {
#include "Wuestite_stx21_em_coder.h"
}


class Wuestite_stx21_em: public EndMember
{
public:
  // Constructor
  Wuestite_stx21_em();
