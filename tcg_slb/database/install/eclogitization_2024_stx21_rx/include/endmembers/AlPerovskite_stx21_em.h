#ifndef ALPEROVSKITE_STX21_EM_H
#define ALPEROVSKITE_STX21_EM_H
...
extern "C" {
#include "AlPerovskite_stx21_em_coder.h"
}


class AlPerovskite_stx21_em: public EndMember
{
public:
  // Constructor
  AlPerovskite_stx21_em();

  // Destructor
  virtual ~AlPerovskite_stx21_em();
