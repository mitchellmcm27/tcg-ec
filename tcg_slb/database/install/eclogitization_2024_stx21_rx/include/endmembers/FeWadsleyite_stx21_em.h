#ifndef FEWADSLEYITE_STX21_EM_H
#define FEWADSLEYITE_STX21_EM_H
...
extern "C" {
#include "FeWadsleyite_stx21_em_coder.h"
}


class FeWadsleyite_stx21_em: public EndMember
{
public:
  // Constructor
  FeWadsleyite_stx21_em();

  // Destructor
  virtual ~FeWadsleyite_stx21_em();
