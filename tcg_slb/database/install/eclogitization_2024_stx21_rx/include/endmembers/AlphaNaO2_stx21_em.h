#ifndef ALPHANAO2_STX21_EM_H
#define ALPHANAO2_STX21_EM_H
...
extern "C" {
#include "AlphaNaO2_stx21_em_coder.h"
}


class AlphaNaO2_stx21_em: public EndMember
{
public:
  // Constructor
  AlphaNaO2_stx21_em();
