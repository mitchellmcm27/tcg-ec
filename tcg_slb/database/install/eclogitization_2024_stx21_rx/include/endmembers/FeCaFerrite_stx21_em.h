#ifndef FECAFERRITE_STX21_EM_H
#define FECAFERRITE_STX21_EM_H
...
extern "C" {
#include "FeCaFerrite_stx21_em_coder.h"
}


class FeCaFerrite_stx21_em: public EndMember
{
public:
  // Constructor
  FeCaFerrite_stx21_em();

  // Destructor
  virtual ~FeCaFerrite_stx21_em();
