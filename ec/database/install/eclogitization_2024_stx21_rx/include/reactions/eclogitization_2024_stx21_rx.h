#ifndef ECLOGITIZATION_2024_STX21_RX_H
#define ECLOGITIZATION_2024_STX21_RX_H

#include "Reaction.h"
#include "phases.h"

class eclogitization_2024_stx21_rx: public Reaction
{
public:
  // Constructor
  eclogitization_2024_stx21_rx();

  // Destructor
  virtual ~eclogitization_2024_stx21_rx();
